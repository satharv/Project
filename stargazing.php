...
<body>
    ...
    <!-- banner image -->
    <div class="img-fluid">
        <img src="images/bannerstargazing.jpg" class="img-fluid w-100 h-75" alt="Responsive image">
    </div>
    <!-- banner image -->

    <!-- jungle safari -->
    <div class="container">
      <h1 class="h1 text-center" style="padding: 30px;"><strong>S T A R &nbsp; G A Z I N G</strong></h1>
      <P class="text-left">There are a very few things in life as beautiful, romantic, serene and calming as a clear night sky filled with hundreds of twinkling stars. Some of the spots in the state that boasts uninterrupted views of a star-studded sky include Gurson Bugyal (near Auli), Jeolikot (near Bhowali), Kedarkantha (Uttarkashi district), Munsiyari (Pithoragarh district), Majhkhali (a small hamlet near Ranikhet), Chakrata and Chaukori. Kausani is also home to an observatory (Stargate Observatory) that even conducts astronomy workshops and Nainital boasts one of the largest telescoped attached to the Aryabhatta Research Institute of Observational Sciences.</P>
      ...
      <div class="container row justify-content-center m-auto justify-content-center " style="padding-bottom: 30px;">
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="kausani.html">
            <figure class="figure1" style="overflow: hidden!important;">
              <img src="images/KAUSANI.jpg" alt="" class="rounded img-fluid" id="img2" >
            </figure></a>
            <h2 class="h4 text-center"><strong>KAUSANI</strong></h2>
        </div>
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="devprayag.html">
            <figure class="figure1" style="overflow: hidden!important;">
              <img src="images/DEVPRAYAG.jpg" alt="" class="rounded img-fluid" id="img2" >
            </figure></a>
            <h2 class="h4 text-center"><strong>DEVPRAYAG</strong></h2>
        </div>
