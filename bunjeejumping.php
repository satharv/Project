...
<body>
    ...
    <!-- banner image -->
    <div class="img-fluid">
        <img src="images/Banner_Bungee_Jumping.jpg" class="img-fluid w-100 h-75" alt="Responsive image">
    </div>
    <!-- banner image -->

    <!-- bunjee jumping -->
    <div class="container">
      <h1 class="h1 text-center" style="padding: 30px;"><strong>B U N G E E &nbsp; J U M P I N G</strong></h1>
      <P class="text-left">Bunjee jumping is more than just a leap of faith. It is a free fall that eliminates fear from the heart and instills courage to overcome the biggest of obstacles. And there is no better place to discover a new you than in the lap of nature surrounded by rolling hills. Rishikesh in Uttarakhand is home to one of the highest bunjee platforms in the country - 83 m (about 272 ft).</P>
      ...
      <div class="container row justify-content-center m-auto justify-content-center " style="padding-bottom: 30px;">
        <div class="col-lg-4 col-sm-6 p-3 shadow"><a href="places/rishikesh.html">
          <figure class="figure1" style="overflow: hidden!important;">
            <img src="images/RISHIKESH.jpg" alt="" class="rounded img-fluid" id="img2" >
          </figure></a>
          <h2 class="h2 text-center"><strong>RISHIKESH</strong></h2>
        </div>
      </div>
    </div>
    <!-- bunjee jumping -->
