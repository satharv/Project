...
<body>
    ...
    <!-- banner image -->
    <div class="img-fluid">
        <img src="images/bannermountainbiking.jpg" class="img-fluid w-100 h-75" alt="Responsive image">
    </div>
    <!-- banner image -->

    <!-- jungle safari -->
    <div class="container">
      <h1 class="h1 text-center" style="padding: 30px;"><strong>P A R A G L I D I N G</strong></h1>
      <P class="text-left">An extreme sport, paragliding can be described as flying in the sky, high above lush dense forests, undulating valleys carpeted in green and snow-capped peaks. And Uttarakhand, bordered by the mighty Himalayan ranges in the north and the undulating Terai plains in the south provides just the perfect the perfect topography for this sky-touching sport. While the experienced can opt for hours of tandem flights and reach a height of over 10,000 ft, beginners can enjoy shorter joy rides and even opt for the training courses offered by tour operators to enjoy longer flights. Some of the best spots for paragliding here include Maldevta (in Dehradun), Bhimtal, Kota Bagh, Nainital, Kausani and Bageshwar.</P>
      <h3 class="h5 text-left">For service Provider : <a href="para-gliding-listing.html">Click here(Paragliding)</a></h3>
      <h3 class="h5 text-left">For service Provider : <a href="aero-sports-listing.html">Click here(Aero Sports)</a></h3>
      <h1 class="h2 text-center" style="padding: 30px;"><strong>E X P L O R E &nbsp; M O R E</strong></h1>
      <div class="container row justify-content-center m-auto justify-content-center " style="padding-bottom: 30px;">
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="nainital.html">
          <figure class="figure1" style="overflow: hidden!important;">
            <img src="images/NAINITAL.jpg" alt="" class="rounded img-fluid" id="img2" >
          </figure></a>
          <h2 class="h4 text-center"><strong>NAINITAL</strong></h2>
        </div>
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="mussoorie.html">
          <figure class="figure1" style="overflow: hidden!important;">
            <img src="images/MUSSOORIE.jpg" alt="" class="rounded img-fluid" id="img2" >
          </figure></a>
          <h2 class="h4 text-center"><strong>MUSSOORIE</strong></h2>
        </div>
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="bhimtal.html">
            <figure class="figure1" style="overflow: hidden!important;">
              <img src="images/BHIMTAL.jpg" alt="" class="rounded img-fluid" id="img2" >
            </figure></a>
            <h2 class="h4 text-center"><strong>BHIMTAL</strong></h2>
        </div>
      </div>
    </div>
    <!-- jungle safari -->
