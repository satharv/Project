...
<body>
    ...
    <!-- banner image -->
    <div class="img-fluid">
        <img src="images/thruhiking-couple.jpg" class="img-fluid w-100 h-75" alt="Responsive image">
    </div>
    <!-- banner image -->
    <!-- feel the thrill -->
    ...
    <!-- explore more -->
    <div class="container-fluid">
        <h1 class="h1 text-center" style="padding-top: 40px; font-weight: 400; padding-bottom: 30px;" ><strong>E X P L O R E &nbsp; M O R E</strong></h1>
        <div class="container row justify-content-center m-auto justify-content-center " style="padding-top: 30px;">
            <div class="col-lg-4 col-sm-6 p-3"><a href="bunjeejumping.php">
              <figure class="figure1" style="overflow: hidden!important;">
                <img src="images/bungeejumping.jpg" alt="" class="rounded img-fluid" id="img2" >
              </figure></a>
            </div>
            <div class="col-lg-4 col-sm-6 p-3"><a href="junglesafari.php">
                <figure class="figure1" style="overflow: hidden!important;">
                  <img src="images/junglesafari.jpg" alt="" class="rounded img-fluid" id="img2" >
                </figure></a>
            </div>
            <div class="col-lg-4 col-sm-6 p-3"><a href="mountainbiking.php">
                <figure class="figure1" style="overflow: hidden!important;">
                  <img src="images/mountain biking.jpg" alt="" class="rounded img-fluid" id="img2" >
                </figure></a>
            </div>
            <div class="col-lg-4 col-sm-6 p-3"><a href="paragliding.php">
                <figure class="figure1" style="overflow: hidden!important;">
                  <img src="images/paraglider2.jpg" alt="" class="rounded img-fluid" id="img2" >
                </figure></a>
            </div>
            <div class="col-lg-4 col-sm-6 p-3"><a href="/riverrafting.php">
                <figure class="figure1" style="overflow: hidden!important;">
                  <img src="images/riverrafting.jpg" alt="" class="rounded img-fluid" id="img2" >
                </figure></a>
            </div>
            <div class="col-lg-4 col-sm-6 p-3"><a href="skiing.php">
                <figure class="figure1" style="overflow: hidden!important;">
                  <img src="images/sking.jpg" alt="" class="rounded img-fluid" id="img2" >
                </figure></a>
            </div>
            <div class="col-lg-4 col-sm-6 p-3"><a href="stargazing.php">
                <figure class="figure1" style="overflow: hidden!important;">
                  <img src="images/stargazing.jpg" alt="" class="rounded img-fluid" id="img2" >
                </figure></a>
            </div>
            <div class="col-lg-4 col-sm-6 p-3"><a href="trekking.php">
                <figure class="figure1" style="overflow: hidden!important;">
                  <img src="images/trekking.jpg" alt="" class="rounded img-fluid" id="img2" >
                </figure></a>
            </div>
            <div class="col-lg-4 col-sm-6 p-3"><a href="watersports.php">
                <figure class="figure1" style="overflow: hidden!important;">
                  <img src="images/watersports.jpg" alt="" class="rounded img-fluid" id="img2" >
                </figure></a>
            </div>
        </div>
    </div>
