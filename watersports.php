...
<body>
    ...
    <!-- banner image -->
    <div class="img-fluid">
        <img src="images/bannerwatersports.jpg" class="img-fluid w-100 h-75" alt="Responsive image">
    </div>
    <!-- banner image -->

    <!-- jungle safari -->
    <div class="container">
      <h1 class="h1 text-center" style="padding: 30px;"><strong>W A T E R &nbsp; S P O R T S</strong></h1>
      <P class="text-left">When it comes to water sports in India, no state cuts a bigger deal than Uttarakhand. Bestowed with frothy and gurgling rivers and serene lakes, it is one of the country’s premier destination for water-based activities - rafting, canoeing, yachting and kayaking. Canoeing and kayaking are two of the most favoured water sports after rafting and can be experienced in Nainital, Sattal and Bhimtal lakes. Adventure tour operators generally conduct training courses on kayaking for the uninitiated before an unforgettable kayaking experience.
      <h3 class="h5 text-left">For Service Provider : <a href="water-sports-listing.html">Click here</a></h3>
      ...
      <div class="container row justify-content-center m-auto justify-content-center" style="padding-bottom: 30px;">
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded" style="padding-right: 20px;"><a href="newtehri.html">
            <figure class="figure1" style="overflow: hidden!important;">
              <img src="images/NEWTEHRI.png" alt="" class="rounded img-fluid" id="img2" >
            </figure></a>
            <h2 class="h4 text-center"><strong>NEWTEHRI</strong></h2>
        </div>
