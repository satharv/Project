...
<body>
    ...
    <!-- bannerimage -->
    <div class="img-fluid">
        <img src="images/eventsbannerimage3.jpg" class="img-fluid w-100" alt="Responsive image">
    </div>
    <!-- bannerimage -->
    <!-- fests -->
    <div class="container" style="padding-top: 60px;padding-bottom: 100px;">
        <h1 class="h1 text-center" style="padding-top: 40px; font-weight: 400; padding-bottom: 70px;" ><strong>O C T O B E R &nbsp; F A I R S &nbsp; A N D &nbsp; F E S T S</strong></h1>
        <h2 class="h2" style="padding-bottom: 25px;">Deepawali Fair</h2>
        <h4 class="h4">Oct 24 to Nov 5</h4>
        <p style="font-weight: 500;padding-bottom: 40px;padding-top: 30px;" class=" w-100 justify-content-center m-auto">This vibrant annual fair is held at Shri Nanakmatta Sahib gurudwara premises in Nanakmatta town, about 50 km from Tanakpur an Rudrapur. The main fair is held on the fourth day by offering ‘bhog’ (sweets) and doing ‘ardaas’ (prayer). Devotees pray, make wishes and promise to return next year upon the fulfillment of their wishes. A large langar (community feast) is organised during the fair. Carnival rides, toy train joyrides, etc. are also setup for youngsters to enjoy.</p>
    </div>
    <!-- fests -->
    ...
    <div class="container" style="display: flex; justify-content: center;" style="background-color: white;">
