...
<body>
    ...
    <div class="container">
      ...
      <div class="container row justify-content-center m-auto justify-content-center " style="padding-bottom: 30px;">
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="sundergangetrek.html">
            <figure class="figure1" style="overflow: hidden!important;">
              <img src="images/SUNDERGANGA.jpg" alt="" class="rounded img-fluid" id="img2" >
            </figure></a>
            <h2 class="h4 text-center"><strong>SUNDERDHUNGA TREK</strong></h2>
        </div>
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="doditaltrek.html">
            <figure class="figure1" style="overflow: hidden!important;">
              <img src="images/DODITALTREK.jpg" alt="" class="rounded img-fluid" id="img2" >
            </figure></a>
            <h2 class="h4 text-center"><strong>DODITAL YAMUNOTRI TREK</strong></h2>
        </div>
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="binsar.html">
            <figure class="figure1" style="overflow: hidden!important;">
              <img src="images/BINSARTREK.jpg" alt="" class="rounded img-fluid" id="img2" >
            </figure></a>
            <h2 class="h4 text-center"><strong>BINSAR TREK</strong></h2>
        </div>
      </div>
    </div>
    <!-- jungle safari -->
