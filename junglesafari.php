...
<body>
    ...
    <!-- banner image -->
    <div class="img-fluid">
        <img src="images/bannerjunglesafari.jpg" class="img-fluid w-100 h-75" alt="Responsive image">
    </div>
    <!-- banner image -->

    <!-- jungle safari -->
    <div class="container">
      <h1 class="h1 text-center" style="padding: 30px;"><strong>J U N G L E &nbsp; S A F A R I</strong></h1>
      <P class="text-left">Driving off into a dense forest in an open jeep and getting up close and almost personal with the wild is exciting. Uttarakhand, with a large forest cover, offers several safari options, including at Corbett National Park and Rajaji National Park.</P>
      <h3 class="h5 text-left">For Safaris : <a href="safari_listing.html">Click here</a></h3>
      ...
      <div class="container row justify-content-center m-auto justify-content-center " style="padding-bottom: 30px;">
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="places/rishikesh.html">
        ...
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="#">
          <figure class="figure1" style="overflow: hidden!important;">
            <img src="images/CORBETTNATIONALPARK.jpg" alt="" class="rounded img-fluid" id="img2" >
          </figure></a>
          <h2 class="h4 text-center"><strong>RAJAJI NATIONAL PARK</strong></h2>
        </div>
      </div>
    </div>
    <!-- jungle safari -->
