...
<body>
    ...
    <!-- banner image -->
    <div class="img-fluid">
        <img src="images/destinationsbanner.jpg" class="img-fluid w-100" alt="Responsive image">
    </div>
    <!-- banner image -->

    <!-- overview -->
    <div class="container" style="padding-bottom: 50px;">
        <h1 class="h1 text-center" style="padding-top: 40px; font-weight: 400; padding-bottom: 30px;" ><strong>F E E L &nbsp; T H E &nbsp; T H R I L L</strong></h1>
        <p style="font-weight: 500;" class="w-100 justify-content-center m-auto">A land of myths and mountains, Devbhoomi Uttarakhand, is one of the most beautiful states of India. Snow-capped Himalayan peaks, serpentine rivers, revered temples, quaint villages, vibrant culture, and World Heritage Sites, Uttarakhand's sheer natural beauty and diversity beckon travelers from across the world.</p>
        <p style="font-weight: 500; padding-top: 15px;" class="w-100 justify-content-center m-auto">Be it river rafting in the Ganges, trekking to some of the fascinating peaks, skiing through some of the picturesque slopes, enjoying a cable-car ride, or soaking in the mesmerising views of the Himalayas, Uttarakhand is a dream destination for all. Here are the top destinations to travel to in Uttarakhand.</p>
    </div>
    <!-- overview -->
    ...
    <div class="container-fliud ">
        <form>
            <div class="form-row align-items-center w-auto align-content-center justify-content-center p-4" style="background-color: black;">
              <div class="col-auto">
                <select class="custom-select mr-sm-5" id="inlineFormCustomSelect" style="background-color: black; color: white;">
                  <option selected style="color: white;">ALL</option>
                  <option value="1" style="color: white;">POPULAR</option>
                  <option value="2" style="color: white;">OFFBEAT</option>
                </select>
              </div>
    ...
    <!-- destinations -->
    <div class="container">
        <h1 class="h1 text-center" style="padding-top: 40px; font-weight: 400; padding-bottom: 30px;" ><strong>D E S T I N A T I O N S</strong></h1>
    </div>
    <div class="container text-center align-content-center" id="chardhamsec1" style="padding-bottom: 40px;">
        <div class="row" style="margin: auto;">
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href="" ><img src="images/desabbotmount.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">ABBOTT MOUNT</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desalmora.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">ALMORA</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desasanbird.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">ASAN BIRD SANCTUARY</h4></a>
            </div>
        </div>
        <div class="row" style="margin: auto;padding-top: 20px;">
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desauli.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">AULI</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desbadrinath.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">BADRINATH</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desBAGESHWAR.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">BAGESHWAR</h4></a>
            </div>
        </div>
        <div class="row" style="margin: auto;padding-top: 20px;">
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desBAIJNATH.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">BAIJNATH</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desBARKOT.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">BARKOT</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/DESBHIMTAL.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">BHIMTAL</h4></a>
            </div>
        </div>
        <div class="row" style="margin: auto;padding-top: 20px;">
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desBHOWALI.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">BHOWALI</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desBINSAR.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">BINSAR</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desCHAKRATA.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">CHAKRATA</h4></a>
            </div>
        </div>
        <div class="row" style="margin: auto;padding-top: 20px;">
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desCHAMOLI.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">CHAMOLI</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desCHOPTA.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">CHOPTA</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desCORBETTNATIONALPARK.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">CORBETT NATIONAL PARK</h4></a>
            </div>
        </div>
        <div class="row" style="margin: auto;padding-top: 20px;">
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desDEHRADUN.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">DEHRADUN</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desGARTANGGALI.webp" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">GARTANG GALI</h4></a>
            </div>
            <div class="col-4 shadow rounded" style="margin: auto;padding: 20px;">
                <a href=""><img src="images/desHEMKUNTSAHIB.jpg" alt="" class="rounded img-fluid" id="img1"><h4 class="h4">HEMKUNT SAHIB</h4></a>
            </div>
        </div>
    </div>
    <!-- destinations -->
