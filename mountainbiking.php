...
<body>
    ...
    <!-- jungle safari -->
    <div class="container">
      <h1 class="h1 text-center" style="padding: 30px;"><strong>M O U N T A I N &nbsp; B I K I N G</strong></h1>
      <P class="text-left">Uttarakhand's diverse terrain offers several challenging routes for mountain biking. A very popular sport in the state, there are trails for beginners and professionals alike. In fact, the annual Ultimate Mountain Terrain Biking Championship, which is said to be Asia’s longest mountain bike race, is held here and draws participants from across the world. Read a traveller's cycling experience here<br>
      <a href="17-day-bicycle-trip-across-kumaon.html">17 day bicycle trip across kumaon</a>
      </P>
      <h3 class="h5 text-left">For Service Provider : <a href="mountain-bikes-listing.html">Click here</a></h3>
      ...
      <div class="container row justify-content-between m-auto justify-content-center " style="padding-bottom: 30px;">
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="chopta.html">
          <figure class="figure1" style="overflow: hidden!important;">
            <img src="images/CHOPTA.jpg" alt="" class="rounded img-fluid" id="img2" >
          </figure></a>
          <h2 class="h4 text-center"><strong>CHOPTA</strong></h2>
        </div>
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="dehradun.html">
          <figure class="figure1" style="overflow: hidden!important;">
            <img src="images/DEHRADUN.jpg" alt="" class="rounded img-fluid" id="img2" >
          </figure></a>
          <h2 class="h4 text-center"><strong>DEHRADUN</strong></h2>
        </div>
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="sattal.html">
            <figure class="figure1" style="overflow: hidden!important;">
              <img src="images/SATTAL.jpg" alt="" class="rounded img-fluid" id="img2" >
            </figure></a>
            <h2 class="h4 text-center"><strong>SATTAL</strong></h2>
        </div>
      </div>
    </div>
    <!-- jungle safari -->
