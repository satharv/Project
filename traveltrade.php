...
<body>
    ...
    <div class="container-fluid" style="margin-bottom: 30px;">   
      <h1 class="h1 text-center shadow-lg card" style="padding: 30px;padding-top: 30px;margin-top:40px;"><strong>T R A V E L &nbsp; T R A D E &nbsp; L I S T I N G</strong></h1>
      <div class="shadow-lg card">      
        <table class="table table-hover table-striped">
          ...
          $selectquery = "select * from traveltrade";
