...
<body>
    ...
    <!-- banner image -->
    <div class="img-fluid">
        <img src="images/bannerskiing.jpeg" class="img-fluid w-100 h-75" alt="Responsive image">
    </div>
    <!-- banner image -->

    <!-- jungle safari -->
    <div class="container">
      <h1 class="h1 text-center" style="padding: 30px;"><strong>S K I I N G</strong></h1>
      <P class="text-left">Auli in Uttarakhand is popularly called the ski capital of India, suited to both beginners and the seasoned. Boasting slopes lined with coniferous trees and carpeted with thick snow during peak season (between December and March), this hill station is equipped with state-of-the-art skiing facilities. Auli, however, is not the only spot. Lesser-known and yet as stunning sites include Daraya Bugyal that offers a 28-sq-km slope, Munsiyari and Mundali.</P>
      ...
      <div class="container row justify-content-center m-auto justify-content-center " style="padding-bottom: 30px;">
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="auli.html">
            <figure class="figure1" style="overflow: hidden!important;">
              <img src="images/AULI.jpg" alt="" class="rounded img-fluid" id="img2" >
            </figure></a>
            <h2 class="h4 text-center"><strong>AULI</strong></h2>
        </div>
      </div>
    </div>
    <!-- jungle safari -->
