...
<body>
    ...
    <!-- banner image -->
    <div class="img-fluid">
        <img src="images/bannerriverrafting.jpg" class="img-fluid w-100 h-75" alt="Responsive image">
    </div>
    <!-- banner image -->

    <!-- jungle safari -->
    <div class="container">
      <h1 class="h1 text-center" style="padding: 30px;"><strong>R I V E R &nbsp; R A F T I N G</strong></h1>
      <P class="text-left">Uttarakhand, with gurgling rivers like Ganga, Yamuna, Alaknanda, Tons, Kali, Kosi and many more, is the ultimate white water rafting destination. Between braving the currents and gently floating, rafting in Uttarakhand can be experienced by the novice, the experienced and even non-swimmers. Rishikesh is one of the most popular rafting destinations. For strong rapids, opt for the stretches along the Alaknanda, Dhauliganga and Kali rivers. Beginners can raft from Barkot to Lakhamandal and Damta to Yamuna Bridge, near Mussoorie. The rafting season is between September and June. Along with rafting, you can also try cliff jumping.</P>
      ...
      <div class="container row justify-content-center m-auto justify-content-center " style="padding-bottom: 30px;">
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="rishikesh.html">
          <figure class="figure1" style="overflow: hidden!important;">
            <img src="images/RISHIKESH.jpg" alt="" class="rounded img-fluid" id="img2" >
          </figure></a>
          <h2 class="h4 text-center"><strong>RISHIKESH</strong></h2>
        </div>
        ...
        <div class="col-lg-4 col-sm-6 p-3 shadow rounded"><a href="corbettnationalpark.html">
            <figure class="figure1" style="overflow: hidden!important;">
              <img src="images/CORBETTNATIONALPARK.jpg" alt="" class="rounded img-fluid" id="img2" >
            </figure></a>
            <h2 class="h4 text-center"><strong>CORBETT NATIONAL PARK</strong></h2>
        </div>
      </div>
    </div>
    <!-- jungle safari -->
